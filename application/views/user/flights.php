                          ...
                          <fieldset>
                            ...
                            <div class="field input-group mb-3">
                              <div class="input-group-prepend">
                                ...
                                <select class="form-control" name="ruteawal" id="ruteawal">
                                    <option value="">Please Select</option>
                                    <?php
                                    foreach ($ruteawa as $rl) {
                                        ?>
                        ...
                        <div class="col">
                          <fieldset>
                            ...
                            <div class="field input-group mb-3">
                              ...
                              <select class="form-control" name="ruteakhir" id="ruteakhir">
                                  <option value="">Please Select</option>
                                  <?php
                                  foreach ($ruteakhi as $rr) {
                                      ?>
                                      <!--di sini kita tambahkan class berisi id provinsi-->
                                      <option <?php echo $ruteakhir_selected == $rr->idrutepesawatfk ? 'selected="selected"' : '' ?> 
                                          class="<?php echo $rr->idrutepesawatfk ?>" value="<?php echo $rr->idruteakhirpes ?>"><?php echo $rr->ruteakhir ?></option>
                                      <?php
                                  }
                                  ?>
                              </select>
