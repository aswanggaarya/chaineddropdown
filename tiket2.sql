...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 24, 2019 at 07:01 AM
...
CREATE TABLE `ruteakhirpesawat` (
  `idruteakhirpes` int(5) NOT NULL,
  `idrutepesawatfk` int(5) NOT NULL,
  `ruteakhir` varchar(100) NOT NULL,
...
INSERT INTO `ruteakhirpesawat` (`idruteakhirpes`, `idrutepesawatfk`, `ruteakhir`, `jamberangkat`, `jamtiba`, `harga`) VALUES
(1, 1, 'DPS-Ngurah Rai Internasional Airport, Bali', '08:00', '10:00', 500000),
(2, 2, 'SUB-Juanda Internasional Airport, Surabaya', '10:00', '12:00', 400000),
(3, 3, 'SUB-Juanda Internasional Airport, Surabaya', '11:00', '12:00', 200000),
(4, 4, 'CGK-Soekarno Hatta Internasional Airport, Jakarta', '07:00', '09:00', 300000);
...
INSERT INTO `rutepesawat` (`idrutepesawat`, `ruteawal`) VALUES
(1, 'CGK-Soekarno Hatta Internasional Airport, Jakarta'),
(2, 'CGK-Soekarno Hatta Internasional Airport, Jakarta'),
(3, 'DPS-Ngurah Rai Internasional Airport, Bali'),
(4, 'DPS-Ngurah Rai Internasional Airport, Bali');
...
ALTER TABLE `ruteakhirpesawat`
  ADD PRIMARY KEY (`idruteakhirpes`);
...
--
ALTER TABLE `ruteakhirpesawat`
  MODIFY `idruteakhirpes` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
